-- NOVA PostgreSQL Seed Data
-- Run this after the schema setup to populate initial data
...
(
    ...
    '$2a$12$LQv3c1yqBTVHhHvjHOKvEe/DatdT4JXiGMp4/kqNl.C1.1H1Q1H1Q', -- password: admin123
    'cabinet_admin',
    'Marie',
    'Dubois',
    '+33 6 12 34 56 78',
...
(
    ...
    '$2a$12$LQv3c1yqBTVHhHvjHOKvEe/DatdT4JXiGMp4/kqNl.C1.1H1Q1H1Q', -- password: practitioner123
    'practitioner',
    'Pierre',
    'Martin',
    '+33 6 23 45 67 89',
...
(
    ...
    '$2a$12$LQv3c1yqBTVHhHvjHOKvEe/DatdT4JXiGMp4/kqNl.C1.1H1Q1H1Q', -- password: patient123
    'patient',
    'Jean',
    'Dupont',
    '+33 6 45 67 89 01',
...
SELECT 'Cabinet created: Cabinet Dentaire Centre-Ville' as info;
SELECT 'Test users created:' as info;
SELECT '  - admin@cabinet-dentaire-cv.fr (admin)' as login_info;
SELECT '  - dr.martin@cabinet-dentaire-cv.fr (practitioner)' as login_info;
SELECT '  - dr.lefebvre@cabinet-dentaire-cv.fr (practitioner)' as login_info;
SELECT '  - patient.test@example.com (patient)' as login_info;
SELECT 'Default password for all test users: password123' as password_info;